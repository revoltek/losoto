...
parser.add_argument('--outsolset', '-u', default=None, dest='outsolset', help='Output solset name [default: same as insolset]')
parser.add_argument('--root', '-o', default='output', dest='root', help='Root of output h5parm names; e.g., root_0.h5, root_1.h5, etc. [default: output]')
